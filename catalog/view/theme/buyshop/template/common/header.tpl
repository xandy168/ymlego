...
#nav ul.rows_outer a,#nav ul.rows_outer a:hover{
...
<link type="text/css" href="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/stylesheet/custom_example.css" rel="stylesheet" />
<?php endif; ?>
...
<nav class="hidden-phone main_menu">
    ...
    <ul id="nav" class="menu megamenu">
        ...
        <li class="level0 last parent dropdown menu_catalog_link item_pages">
            ...
            <?php if ($category['children']) : ?>
            <ul class="level0 <?php echo ($category['column'] > 1 ? 'level_margin' : 'one-column'); ?>">
                <li>
                    <ul class="shadow">
                        <li class="row_middle">
                            <ul class="rows_outer">
...
<?php endforeach; ?>
        ...
        <li>
            <a class="contact-button" href="<?php if ($theme_options["contacts_link_url"] !== '' ) {echo $theme_options["contacts_link_url"];} else {echo 'index.php?route=information/contact';} ?>">
                                <?php
