            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                <table class="form">
                    ...
                    <tr>
                        ...
                        <td><select name="allpay_<?php echo $entry_subfix; ?>_order_status_id" class="_disabled" disabled="disabled">
                                <?php foreach ($order_statuses as $order_status) { ?>
                                <?php if ($order_status['order_status_id'] == '1') { ?>
                    ...
                    <tr>
                        ...
                        <td><select name="allpay_<?php echo $entry_subfix; ?>_order_finish_status_id" class="_disabled" disabled="disabled">
                                <?php foreach ($order_statuses as $order_status) { ?>
