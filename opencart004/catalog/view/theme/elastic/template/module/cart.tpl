<div id="cart" class="dropdown padded">
  <span class="button pink">
    <?php echo $heading_title; ?>
  </span>
  <ul role="menu" aria-hidden="true" aria-expanded="false"><li>
  <a><span id="cart-total"><?php echo $text_items; ?></span></a><br/>
