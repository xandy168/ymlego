...
$_['entry_code']                = '追蹤碼(Tracking Code)<span class="help">追蹤碼用於確認連結來源(The tracking code that will be used to track referrals).</span>';
$_['entry_commission']          = '獎金比例(Commission) (%)<span class="help">提供訂單金額的多少百分比做為獎金(Percentage the affiliate recieves on each order.)</span>';
$_['entry_tax']                 = '稅務人(Tax ID)';
$_['entry_payment']             = '付款方式(Payment Method)';
$_['entry_cheque']              = '支票收款人(Cheque Payee Name)';
$_['entry_paypal']              = 'PayPal帳號(PayPal Email Account)';
$_['entry_bank_name']           = '銀行名稱(Bank Name)';
$_['entry_bank_branch_number']  = '銀行代碼(Branch Number)';
$_['entry_bank_swift_code']     = '銀行通滙代號(SWIFT Code)';
$_['entry_bank_account_name']   = '戶名(Account Name)';
$_['entry_bank_account_number'] = '帳號(Account Number)';
...
$_['error_postcode']            = '郵遞區號必須在2至10個字元之間';
