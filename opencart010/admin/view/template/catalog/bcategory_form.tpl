  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-bcategory" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-bcategory" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="tab-data">
                <!--additional images-->
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="input-icon">
                        ...
                        <div style="font-weight:normal;">
                            ...
                            category_icons/category-icon-01.png
                        </div>
                    </label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="input-topmenu">
                        <strong style="color:red">NEW! </strong>
                        <span data-toggle="tooltip" title="<?php echo $help_topmenu; ?>"><?php echo $entry_topmenu; ?></span>
                        <div style="font-weight:normal;">
                            for example, you can enter such path:<br>
                            category_icons/menu-img-right.jpg
                        </div>

                    </label>
                    <div class="col-sm-8">
                        <input type="text" name="topmenu" value="<?php echo $topmenu; ?>" placeholder="<?php echo $entry_topmenu; ?>" id="input-topmenu" class="form-control" />
                    </div>
                </div>
                <!--additional images-->
...
$('input[name=\'path\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/bcategory/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
